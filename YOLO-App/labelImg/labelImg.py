...
from labelImg.InferenceSet import InferenceSet
...
class MainWindow(QMainWindow, WindowMixin):
    ...
    def __init__(self, default_filename=None, default_prefdef_class_file=None, default_save_dir=None,parent=None):
        ...
        close = action("Back", self.verify_image, 'Ctrl+W', '', '')
        ...
        zoom_in = action(get_str('zoomin'), partial(self.add_zoom, 10),
                         'Ctrl++', 'zoom-in', '', enabled=False)
        zoom_out = action(get_str('zoomout'), partial(self.add_zoom, -10),
                          'Ctrl+-', 'zoom-out', '', enabled=False)
        ...
        self.actions = Struct(save=save, save_format=save_format, saveAs=save_as, open=open, close=close, resetAll=reset_all, deleteImg=delete_image,
                              ...
                              fileMenuActions=(
                                   open_dir, save, save_as, close, quit),
                              beginner=(), advanced=(),
                              editMenu=(open, edit, delete,
                                        None),
                              beginnerContext=(open,create,  delete),
                              advancedContext=(open, create_mode, edit_mode, edit,
                                               delete),
                              onLoadActive=(
        ...
        add_actions(self.menus.file,
                    ( open_dir, change_save_dir, save, save_format, save_as, close, quit))
        ...
        self.menus.help.aboutToShow.connect(self.helpButton)
        ...
        self.actions.beginner = (
             open_next_image, open_prev_image, save, save_format, None, create,  delete, None,
            zoom_in, zoom, zoom_out)
    ...
    def helpButton (self):
        ...
        # msgBox.setText(" 1. Add Config. - It is use to set the configuration file \n\n 2. O
        msgBox.setText(" 1. Add Config. - It is use to set the configuration file. \n\n 2. Open Dir - It is use to open a directory. \n\n 3.  Next Image -  It is used to access next image \n\n 4. Prev Image -  It is used to access previous image \n\n 5. Create ReactBox - It is used to draw the rectangular boxes on the images \n\n 6. Delete ReactBox - It is used to delete the rectangular boxes on the images \n\n 7. Back - It is used to go back to login page \n\n 8. Edit label - It is used to edit the label. \n\n 9. Help - It gives Information of all the pages \n\n 10. Quit - It is used to quit the application ")
    ...
    def open_file(self, _value=False):
        ...
        values = InferenceSet.launch(self)
